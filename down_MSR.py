...
with open('train_val_videodatainfo.json', 'r', encoding='utf-8') as f:
    try:
        listA = json.load(f)['sentences']
        for cell in listA:
            lines.append(cell["caption"])
    except:
        pass
...
keywords_url_json_folder_path = './keywords_youtube_url_json_folder_{}_60'.format(part_index)
